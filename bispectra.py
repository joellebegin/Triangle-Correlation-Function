...
def tcf(field, length = 400, cutoff = False):
    ...
    return bispectra, norms_k, norms_q, p, k_vals
...
def main():
    ...
    stuff = np.vstack((data[0], data[1], data[2], data[3]))
    np.savetxt('bispectra_et_al.txt', stuff, delimiter=',')    
